...
public final class CommandScenarios {
    ...
    public static void inspectWithSelectorExecutesThroughTheDispatcher(GameTestHelper helper) {
    ...
    public static void inspectWithoutArgumentRaycastsTheCrosshairEntity(GameTestHelper helper) {
    ...
    public static void checkWithItemArgumentExecutesThroughTheDispatcher(GameTestHelper helper) {
