 ...
 */
public final class SpellScenarios {
    ...
    public static void indirectDamageRollsAsSpellWithDerivedDice(GameTestHelper helper) {
    ...
    public static void spellRollsDisabledRestoresVanilla(GameTestHelper helper) {
        Husk husk = spawnCalm(helper, EntityType.HUSK, 1, 1);
        Pig pig = spawnCalm(helper, EntityType.PIG, 3, 3);
    ...
    public static void unknownSpellPassthroughLeavesVanilla(GameTestHelper helper) {
        Husk husk = spawnCalm(helper, EntityType.HUSK, 1, 1);
        Pig pig = spawnCalm(helper, EntityType.PIG, 3, 3);
        Rules base = Rules.DEFAULTS;
        Rules rules = new Rules(
    ...
    public static void successfulSaveHalvesTheDamage(GameTestHelper helper) {
        Husk husk = spawnCalm(helper, EntityType.HUSK, 1, 1);
        Pig pig = spawnCalm(helper, EntityType.PIG, 3, 3);
        withSpellProfile(
                SAVE_PROFILE,
    ...
    public static void failedSaveTakesFullProfileDice(GameTestHelper helper) {
        Husk husk = spawnCalm(helper, EntityType.HUSK, 1, 1);
        Pig pig = spawnCalm(helper, EntityType.PIG, 3, 3);
        withSpellProfile(
                SAVE_PROFILE,
    ...
    public static void negateOutcomeCancelsAllDamageOnSave(GameTestHelper helper) {
        Husk husk = spawnCalm(helper, EntityType.HUSK, 1, 1);
        Pig pig = spawnCalm(helper, EntityType.PIG, 3, 3);
    ...
    public static void targetProfileSaveBonusCounts(GameTestHelper helper) {
        Husk husk = spawnCalm(helper, EntityType.HUSK, 1, 1);
        Pig pig = spawnCalm(helper, EntityType.PIG, 3, 3);
        String nimblePig =
    ...
    public static void savesDisabledFallBackToAttackRoll(GameTestHelper helper) {
        Husk husk = spawnCalm(helper, EntityType.HUSK, 1, 1);
        Pig pig = spawnCalm(helper, EntityType.PIG, 3, 3);
        Rules base = Rules.DEFAULTS;
        Rules rules = new Rules(
    ...
    private static DamageSource spellSource(GameTestHelper helper, LivingEntity caster) {
        ...
        // source — direct entity = proxy, causing entity = caster — through the public constructor.
        Holder<DamageType> type = helper.getLevel()
                .registryAccess()
                .registryOrThrow(Registries.DAMAGE_TYPE)
                .getHolderOrThrow(DamageTypes.MOB_ATTACK);
        return new DamageSource(type, proxy, caster);
    }
