 ...
 */
public final class OutcomeScenarios {
    ...
    public static void natTwentyAppliesStatusEffectFromDefaultTable(GameTestHelper helper) {
    ...
    public static void natTwentyKnockbackShovesTheTarget(GameTestHelper helper) {
        Husk husk = spawnCalm(helper, EntityType.HUSK, 1, 1);
        Pig pig = spawnCalm(helper, EntityType.PIG, 3, 3);
        husk.setItemSlot(EquipmentSlot.MAINHAND, new ItemStack(Items.IRON_SWORD));
        withTables(
    ...
    public static void fumbleHitsNearestAllyWithTheAttacksDice(GameTestHelper helper) {
        Husk husk = spawnCalm(helper, EntityType.HUSK, 1, 1);
    ...
    public static void barehandedMobFumbleCanHitItsPackmate(GameTestHelper helper) {
    ...
    public static void hitNearestAllyIgnoresPlayersWhenPolicyForbidsIt(GameTestHelper helper) {
        Husk husk = spawnCalm(helper, EntityType.HUSK, 1, 1);
        Pig target = spawnCalm(helper, EntityType.PIG, 3, 1);
    ...
    public static void hitNearestAllyRespectsTheServerPvpRule(GameTestHelper helper) {
    ...
    public static void hitNearestAllyRespectsTeamFriendlyFire(GameTestHelper helper) {
        Player attacker = mockPlayerAt(helper, 1.5, 1.5);
        Pig target = spawnCalm(helper, EntityType.PIG, 3, 1);
    ...
    public static void fumbleSelfDamageRollsTheConfiguredDice(GameTestHelper helper) {
        Player attacker = mockPlayerAt(helper, 1.5, 1.5);
        Pig target = spawnCalm(helper, EntityType.PIG, 3, 1);
        attacker.setItemInHand(InteractionHand.MAIN_HAND, new ItemStack(Items.IRON_SWORD));
        Rules rules = withFumbles(fumbles(
    ...
    public static void fumbleDropsTheWeapon(GameTestHelper helper) {
        Husk husk = spawnCalm(helper, EntityType.HUSK, 1, 1);
    ...
    public static void fumbleStumbleSlowsTheAttacker(GameTestHelper helper) {
        Husk husk = spawnCalm(helper, EntityType.HUSK, 1, 1);
        Pig target = spawnCalm(helper, EntityType.PIG, 3, 3);
        husk.setItemSlot(EquipmentSlot.MAINHAND, new ItemStack(Items.IRON_SWORD));
        Rules rules = withFumbles(fumbles(
    ...
    public static void fumbleReturnsDurabilityConsequence(GameTestHelper helper) {
        Husk husk = spawnCalm(helper, EntityType.HUSK, 1, 1);
        Pig pig = spawnCalm(helper, EntityType.PIG, 3, 3);
        husk.setItemSlot(EquipmentSlot.MAINHAND, new ItemStack(Items.IRON_SWORD));
        withRolls(
    ...
    public static void disabledConsequenceIsANoOpEvenWhenPicked(GameTestHelper helper) {
        Husk husk = spawnCalm(helper, EntityType.HUSK, 1, 1);
        Pig target = spawnCalm(helper, EntityType.PIG, 3, 3);
        husk.setItemSlot(EquipmentSlot.MAINHAND, new ItemStack(Items.IRON_SWORD));
    ...
    public static void appliesToMobsOnlySuppressesPlayerFumbles(GameTestHelper helper) {
        Player attacker = mockPlayerAt(helper, 1.5, 1.5);
        Pig target = spawnCalm(helper, EntityType.PIG, 3, 1);
        attacker.setItemInHand(InteractionHand.MAIN_HAND, new ItemStack(Items.IRON_SWORD));
        Rules rules = withFumbles(fumbles(
    ...
    public static void missMarginTableFiresOnABigMiss(GameTestHelper helper) {
        Husk husk = spawnCalm(helper, EntityType.HUSK, 1, 1);
